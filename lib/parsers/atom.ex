defmodule Feedex.Parsers.Atom do
  ...
  @schema [
    ...
    url_alts: ~x'/feed/link[not(@rel="self")]/@href'ls |> add_namespace("", "http://www.w3.org/2005/Atom"),
    ...
    entries: [ ~x'/feed/entry'l |> add_namespace("", "http://www.w3.org/2005/Atom"),
      ...
      url: ~x'./link[not(@rel="enclosure")]/@href's |> add_namespace("", "http://www.w3.org/2005/Atom") |> transform_by(&strip/1),
