defmodule Feedex.Helpers.Sanitizers.HTML do
  ...
  Meta.allow_tag_with_these_attributes "video", ["lang", "title", "translate", "poster", "preload", "muted", "controls", "width", "height"]

  Meta.allow_tag_with_uri_attributes   "source", ["src"], @valid_schemes
  Meta.allow_tag_with_these_attributes "source", ["lang", "title", "translate", "type", "media"]
